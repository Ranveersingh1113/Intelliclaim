...
const IntelliClaimDemo = () => {
  ...
  const UPLOAD_ENDPOINT = "http://localhost:8000/upload-document";
  const UPLOAD_URL_ENDPOINT = "http://localhost:8000/upload-document-url";
  const DOCUMENTS_ENDPOINT = "http://localhost:8000/documents";
  const STATS_ENDPOINT = "http://localhost:8000/system-stats";
